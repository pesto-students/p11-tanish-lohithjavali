...
const myObject2 = Object.create(myProto, {
  ...
  age: {
    ...
    enumerable: true, // Whether the property should be included when iterating over the object's keys // and when we access the key using object's dot  / bracket notation - ex: object.key()
  },
});
